...
function run_xxz(L; h, J, Jzz)
	...
	rbm = MPS(Float64, n_visible, D=20)
	rightorth!(rbm)
	sampler = BatchAutoRegressiveSampler(n_visible, n_sample_per_chain=10000, constrain=U1Discard(L, c=div(L,2)))	
	# sampler = BatchAutoRegressiveSampler(n_visible, n_sample_per_chain=10000000000, constrain=U1Mask(L, c=div(L,2)))
