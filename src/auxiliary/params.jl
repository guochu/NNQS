...
# function _collect_parameters!(v::AbstractVector, p::AbstractArray)
# 	for x in p
# 		_collect_parameters!(v, x)
# 	end
# 	return v
# end
# _collect_parameters!(v::AbstractVector, p::Nothing) = v
...
# function _reset_parameters_util!(x::AbstractArray, v::AbstractVector, pos::Int)
# 	for item in x
