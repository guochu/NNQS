"""
	...
	"""
function energy_and_grad(h::Hamiltonian, nnqs::AbstractNNQS, sampler::AbstractSampler; n_chain_per_rank::Int=10, 
	seeds::Union{Vector{Int}, Nothing}=nothing, λ::Real = 1.0e-6, verbosity::Int=1)
	# samples = generate_samples(sampler, nnqs)
	energies_and_grads = energy_and_grad_per_rank(h, nnqs, sampler, n_chain_per_rank=n_chain_per_rank, seeds=seeds)
...
function energy_and_grad_per_rank(h::Hamiltonian, nnqs::AbstractNNQS, sampler::AbstractSampler; n_chain_per_rank::Int=10, 
